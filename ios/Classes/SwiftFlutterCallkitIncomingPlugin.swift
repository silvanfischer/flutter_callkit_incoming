...
public class SwiftFlutterCallkitIncomingPlugin: NSObject, FlutterPlugin, CXProviderDelegate {
    ...
    static let ACTION_DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP = "io.fibe.busti.DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP"
    
    static let ACTION_CALL_INCOMING = "io.fibe.busti.ACTION_CALL_INCOMING"
    static let ACTION_CALL_START = "io.fibe.busti.ACTION_CALL_START"
    static let ACTION_CALL_ACCEPT = "io.fibe.busti.ACTION_CALL_ACCEPT"
    static let ACTION_CALL_DECLINE = "io.fibe.busti.ACTION_CALL_DECLINE"
    static let ACTION_CALL_ENDED = "io.fibe.busti.ACTION_CALL_ENDED"
    static let ACTION_CALL_TIMEOUT = "io.fibe.busti.ACTION_CALL_TIMEOUT"
    static let ACTION_CALL_CUSTOM = "io.fibe.busti.ACTION_CALL_CUSTOM"
    
    static let ACTION_CALL_TOGGLE_HOLD = "io.fibe.busti.ACTION_CALL_TOGGLE_HOLD"
    static let ACTION_CALL_TOGGLE_MUTE = "io.fibe.busti.ACTION_CALL_TOGGLE_MUTE"
    static let ACTION_CALL_TOGGLE_DMTF = "io.fibe.busti.ACTION_CALL_TOGGLE_DMTF"
    static let ACTION_CALL_TOGGLE_GROUP = "io.fibe.busti.ACTION_CALL_TOGGLE_GROUP"
    static let ACTION_CALL_TOGGLE_AUDIO_SESSION = "io.fibe.busti.ACTION_CALL_TOGGLE_AUDIO_SESSION"
